...
function AddDay({ getFunction, openModal, setOpenModal }) {
  ...
  const { pack, group, lecture, subject } = useParams();
  ...
  const saveNewDay = async (e) => {
    ...
    formDataObj.append("package_id", subject);
    formDataObj.append("group_id", subject);
    formDataObj.append("lecture_price", "120");
    formDataObj.append("lec_sub_id", subject);
    formDataObj.append(
      "lec_arrangement ",
