...
function VideoScores() {
  const { yearID, video } = useParams();
  ...
  const getData = async () => {
    try {
      const response = await fetch(secondUrl + "video_students_score.php", {
        method: "POST",
