...
import AddVideo from "../../components/oneCourse/videos/add";
import DeleteVideo from "../../components/oneCourse/videos/delete";
import EditVideo from "../../components/oneCourse/videos/edit";
import PdfOpen from "../../components/oneCourse/videos/pdf";
import ShowHideVideo from "../../components/oneCourse/videos/showHide";
  ...
  const getAllMyVediosFor = async () => {
    ...
    try {
      const response = await axios.post(
        "https://Camp-coding.tech/teachersApp2024/Ezz_Zatona/doctor/home/select_free_videos.php",
        data_to_send
      );
        ...
        <DropMenu child={"Actions"}>
          <div className="actions-btns">
            ...
            <div className="rowDiv">
              <button
                className={`btn ${
                  (row?.hidden == 0) ? "btn-danger" : "btn-success"
                }`}
                onClick={async () => {
                  try {
